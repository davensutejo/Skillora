...
from manim_speech import SpeechScene, set_speech_service
import numpy as np
...
# Set up speech service - manim-speech uses a different approach than manim-voiceover
set_speech_service('gTTS')

class PracticalApplicationsofSecurityFundamentalsScene(SpeechScene):
    def construct(self):
        # Course title and topic introduction with voice narration
        topic = "Practical Applications of Security Fundamentals"
        
        # SECTION 1: Introduction
        self.next_section("Introduction", PresentationSectionType.NORMAL)
        with self.speech("Welcome to this educational video on " + topic + "."):
            title = Text(topic, font_size=48)
            self.play(Write(title))
            self.wait(1)
        
        # Subtitle with author information
        with self.speech("In this video, we'll explore the key concepts and applications of this important topic."):
        ...
        with self.speech("Let's start with an overview of what we'll cover today."):
        ...
        with self.speech("Now, let's dive into the main content of " + topic + "."):
            ...
            # Concept 1
            with self.speech("First, let's explore the fundamental concepts."):
            ...
            # Concept 2
            with self.speech("Next, let's look at another important aspect."):
        ...
        with self.speech("Let's see how these concepts apply in real-world scenarios."):
...
'''
        ...
        with self.speech("Let's summarize what we've learned about " + topic + "."):
            ...
            with self.speech("Thanks for watching this video on " + topic + "."):
